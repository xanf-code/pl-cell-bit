  ...
  return (
    <body>
      <section className="min-h-screen flex items-stretch text-white ">
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center bg-[url(https://college4u.in/wp-content/uploads/2017/01/bit.jpg)]">
          <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
          <div className="w-full px-24 z-10">
            <h1 className="text-5xl font-bold text-left tracking-wide">Bangalore Institute of Technology</h1>
            <p className="text-3xl my-4">Placement Cell Management System</p>
          </div>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#161616]">
          ...
          <div className="w-full py-6 z-20">
            {!data ? <div onClick={() => signIn(providers.google.id, {
              ...
              <div className="bg-blue-50 inline-block rounded-md cursor-pointer hover:bg-blue-100 transition ease-in-out duration-150">
                <h1 className="p-2 m-2 text-blue-500 font-semibold text-lg">Sign in to access the dashboard 👋</h1>
              </div>
